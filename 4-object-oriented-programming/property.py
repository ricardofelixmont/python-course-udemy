...
class Funcionario:
    ...
    @property       # transforma um metodo em atributo, posso usar quando o unico argumento do metodo é o 'self'
    def comissao(self):
        return self.salario * 5
    
funcionario = Funcionario('Ricardo', 'Engenheiro', 1200)
# print(funcionario.comissao())
# posso utilizar esse metodo como um atributo utilizando o @property
print(funcionario.comissao)
